  ...
  return (
    <>
      <div className="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div className="row g-4">
                    <div className="col-sm-12 col-xl-6">
                        <div className="bg-light text-center rounded p-4">
                            ...
                            <canvas id="worldwide-sales" width="422" height="211" style={{"display": "block", "height": "211px", "width": "422px"}}></canvas>
                        </div>
                    </div>
                    <div className="col-sm-12 col-xl-6">
                        <div className="bg-light text-center rounded p-4">
                            ...
                            <canvas id="salse-revenue" width="422" height="211" style={{"display": "block", "height": "211px", "width": "422px"}}></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {/* <!-- Back to Top --> */}
        <a href="#" className="btn btn-lg btn-primary btn-lg-square back-to-top" style={{"display": "none"}}><i className="bi bi-arrow-up"></i></a>
    </div>
    </>  
    );
}
